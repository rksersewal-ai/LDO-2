  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-slate-400 text-sm">LDO-2 EDMS component library and design tokens reference.</p>
      </div>

      {/* Colors */}
      <GlassCard className="p-6">
        <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Palette className="w-5 h-5 text-teal-400" /> Colors</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { name: 'Teal Primary', class: 'bg-teal-500', text: 'text-white' },
            { name: 'Emerald Accent', class: 'bg-emerald-500', text: 'text-white' },
            { name: 'Slate Base', class: 'bg-slate-900', text: 'text-white' },
      ...
      {/* Badges */}
      <GlassCard className="p-6">
        <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Box className="w-5 h-5 text-teal-400" /> Badges</h2>
      ...
      {/* Buttons */}
      <GlassCard className="p-6">
        <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Sparkles className="w-5 h-5 text-teal-400" /> Buttons</h2>
        <div className="flex flex-wrap gap-3">
      ...
      {/* Typography */}
      <GlassCard className="p-6">
        <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Type className="w-5 h-5 text-teal-400" /> Typography</h2>
        <div className="space-y-3">
          ...
          <h3 className="text-lg font-semibold text-slate-200">Heading 3 — Semibold Slate-200</h3>
          <p className="text-sm text-slate-300">Body text — Slate-300 at 14px. Used for most paragraph content.</p>
          <p className="text-xs text-slate-400">Caption text — Slate-400 at 12px. Used for metadata and labels.</p>
          <p className="font-mono text-xs text-teal-400">Monospace — Teal-400. Used for IDs, codes, and technical values.</p>
        </div>
      </GlassCard>
      ...
      <GlassCard className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <GlassCard className="p-4 text-center">
            <p className="text-xs text-slate-400">Default Card</p>
          </GlassCard>
          <GlassCard className="p-4 text-center border-teal-500/40">
            <p className="text-xs text-slate-400">Highlighted Card</p>
          </GlassCard>
          <GlassCard className="p-4 text-center border-amber-500/30 bg-amber-950/10">
            <p className="text-xs text-slate-400">Warning Card</p>
          </GlassCard>
        </div>
      </GlassCard>
    </div>
