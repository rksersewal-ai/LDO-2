      ...
      >
        ...
        <div className="p-6 flex flex-col items-center relative">
          ...
          {isExpanded && (
            <button
              ...
              className="absolute top-4 right-4 w-8 h-8 bg-sidebar-accent/50 hover:bg-sidebar-accent rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 focus-visible:ring-2 focus-visible:ring-sidebar-primary focus-visible:outline-none"
                ...
                <div key={item.id} className="relative group">
                  <button
                    ...
                    className={cn(
                      ...
                      "hover:scale-110 hover:shadow-lg focus-visible:ring-2 focus-visible:ring-sidebar-primary focus-visible:outline-none",
                      isExpanded 
        ...
        <div className="p-4 flex justify-center">
          <div className="relative group">
            <button
              className="w-12 h-12 bg-gradient-to-br from-sidebar-primary to-sidebar-primary/80 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-sidebar-primary focus-visible:outline-none"
